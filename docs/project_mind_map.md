  ...
  root((Шерстяной Синдикат: 9 Жизней))
    ...
    Ресурсы
      ...
      Кузница
        ...
        "крит успех экипировки повышает качество вместо дубля"
...
4. Материалы и небольшая оплата рыбами тратятся в `/craft` на экипировку.
...
6. В `🎒 Инвентарь` нажать кнопку экипировки.
7. Для классового оружия проверить, что надеть можно только оружие своего класса.
8. Проверить `🧥 Экипировка`.
